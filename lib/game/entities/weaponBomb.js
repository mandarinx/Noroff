...
EntityWeaponBomb = EntityWeapon.extend({
	...
	animSheet: new ig.AnimationSheet('media/weapon_bomb.png', 16, 16),

	init: function( x, y, settings ) {
        this.addAnim('idle', .1, [0,1,2,1]);
//		ig.input.bind(ig.KEY._1, this.weaponName);
