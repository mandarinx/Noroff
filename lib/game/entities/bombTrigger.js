...
EntityBombTrigger = ig.Entity.extend({
	size: {x: 16, y: 16},
	
	_wmScalable: true,
	_wmDrawBox: true,
	_wmBoxColor: 'rgba(64, 255, 0, 0.7)',
	...
	sfx: new ig.Sound('media/explode_wall.*'),
	...
	check: function(other) {
		if (this.canFire && this.waitTimer.delta() >= 0 && other.entityType == "bomb") {
